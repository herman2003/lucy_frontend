...
void main() {
  test(
    'bootstrap restores remote progress transcript into chat state',
    () async {
  ...
  test(
    'bootstrap resumes awaiting_final_confirm with pending analysis',
    () async {
  ...
  test(
    'bootstrap runs analyze when awaiting_analyze with full transcript',
    () async {
  ...
  test(
    'bootstrap restores local draft when remote progress is empty',
    () async {
      ...
      final localDrafts = {'test-uid': draft};
