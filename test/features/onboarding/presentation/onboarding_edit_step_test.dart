...
void main() {
  test(
    'beginEditCompletedStep keeps other step threads and truncates turns',
    () async {
      ...
      expect(
        state.completedTurns.first.questionId,
        OnboardingQuestionIds.qRole,
      );
      expect(
        state.messagesByQuestionId[OnboardingQuestionIds.qRole],
        isNotEmpty,
      );
      expect(
        state.messagesByQuestionId[OnboardingQuestionIds.qGoal],
        isNotEmpty,
      );
